  ...
  return (
    <>
      <div className='relative top-[7rem] flex flex-col items-center p-2'>
        <div className="w-full mx-auto max-w-md p-4 rounded-md shadow sm:p-8 bg-neutral my-10 text-white">
          ...
          <p className="text-md text-center text-white">Dont have account?
            <span className="focus:underline hover:underline cursor-pointer text-blue-300 ml-2 font-semibold"><Link to="/login">Log In here</Link></span>
          </p>
          <div className="my-6 space-y-4 ">
            <button onClick={googleRegister} aria-label="Register with Google" type="button" className=" active:bg-red-600 hover:bg-error duration-300 font-semibold focus:none outline-none hover:text-white flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 border-white ">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
                <path d="M16.318 13.714v5.484h9.078c-0.37 2.354-2.745 6.901-9.078 6.901-5.458 0-9.917-4.521-9.917-10.099s4.458-10.099 9.917-10.099c3.109 0 5.193 1.318 6.38 2.464l4.339-4.182c-2.786-2.599-6.396-4.182-10.719-4.182-8.844 0-16 7.151-16 16s7.156 16 16 16c9.234 0 15.365-6.49 15.365-15.635 0-1.052-0.115-1.854-0.255-2.651z"></path>
              </svg>
              <p>Register with Google</p>
            </button>
            <button onClick={gitHubRegister} aria-label="Register with GitHub" role="button" className="active:bg-blue-700 hover:bg-accent duration-300 font-semibold focus:none outline-none hover:text-white flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 border-white ">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
            ...
            {/* <button aria-label="Register with Twitter" role="button" className=" active:bg-blue-600 hover:bg-blue-400 duration-300 font-semibold focus:none outline-none hover:text-white  flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 border-white ">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
          ...
          <form className="space-y-8 ng-untouched ng-pristine ng-valid" onSubmit={handleRegister}>
            <div className="space-y-4">
              <div className="space-y-2">
                <label className="block text-md font-semibold text-base-100 tracking-wider">Your Name</label>
              ...
              <div className="space-y-2">
                <label className="block text-md font-semibold text-base-100 tracking-wider">Photo URL</label>
                ...
                <p className='pt-2 text-error text-[14px] font-medium italic'>{error}</p>
              </div>
            </div>
            <button type="submit" className="w-full px-8 py-3 font-semibold rounded-md hover:bg-neutral hover:border-2 duration-300 transition bg-blue-400 text-gray-50">Register</button>
          </form>
        </div>
      </div>
    </>
